...
func insertUser(user models.User) int64 {
	...
	sqlStatement := `
		INSERT INTO users (name, location, age) 
		VALUES ($1, $2, $3) 
		RETURNING userid
	`
...
func getUser(id int64) (models.User, error) {
	...
	err := db.QueryRow(sqlStatement, id).Scan(&user.ID, &user.Name, &user.Age, &user.Location)
...
func updateUser(id int64, user models.User) int64 {
	...
	sqlStatement := `
		UPDATE users 
		SET name=$2, age=$3, location=$4
		WHERE userid=$1
	`

	res, err := db.Exec(sqlStatement, id, user.Name, user.Age, user.Location)
